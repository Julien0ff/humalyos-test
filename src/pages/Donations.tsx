    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="bg-primary pt-32 pb-20 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <Heart className="w-20 h-20 mx-auto mb-8 text-secondary animate-pulse fill-secondary" />
            ...
            <p className="text-xl font-bold text-slate-300 max-w-2xl mx-auto uppercase tracking-widest">
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-12 md:p-16 border-b md:border-b-0 md:border-r border-slate-100">
                <h2 className="text-3xl font-black text-primary mb-8 uppercase tracking-tighter">Pourquoi donner ?</h2>
                <div className="space-y-8">
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h4 className="font-black text-primary uppercase text-sm tracking-wider mb-2">Indépendance</h4>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      <h4 className="font-black text-primary uppercase text-sm tracking-wider mb-2">Proximité</h4>
              ...
              <div className="p-12 md:p-16 bg-slate-50/50">
                <div className="bg-white p-8 rounded-2xl shadow-inner border border-slate-100">
                  <h3 className="text-xl font-black text-primary mb-6 uppercase tracking-tight text-center">Faire un don sécurisé</h3>
                  ...
                  <a 
                    ...
                    className="flex items-center justify-center w-full bg-secondary text-white py-5 rounded-xl font-black uppercase tracking-widest hover:bg-primary transition-all shadow-lg"
                  >
                    DONNER SUR TIPEEE
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-primary mb-8">Transparence & Confiance</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6">
              <h3 className="font-bold text-secondary mb-2">Sécurisé</h3>
