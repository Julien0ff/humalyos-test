        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <div className="flex flex-col">
                <h2 className="text-3xl font-bold text-white tracking-tighter leading-none font-poppins">HUMALYOS</h2>
                <span className="text-[10px] font-medium text-accent tracking-[0.3em] uppercase mt-1 font-poppins">Antenne Nationale</span>
              </div>
            </div>
            ...
            <div className="flex space-x-5">
              ...
              <a href="https://www.linkedin.com/company/an-humalyos/" className="bg-white/10 p-3 rounded-full hover:bg-accent transition-colors"><Linkedin className="w-5 h-5" /></a>
              <a href="https://www.instagram.com/an_humalyos?igsh=a2c2aW5zMDRweHdi" className="bg-white/10 p-3 rounded-full hover:bg-accent transition-colors"><Instagram className="w-5 h-5" /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/dons" className="text-slate-300 hover:text-white font-bold transition-colors uppercase text-sm text-accent">Faire un don</Link></li>
            </ul>
          </div>

          {/* Contact Info */}
          <div>
            <h3 className="text-sm font-bold text-accent mb-8 uppercase tracking-[0.2em] font-poppins">Contact</h3>
            <ul className="space-y-6">
              <li className="flex items-start">
                <MapPin className="w-5 h-5 mr-4 text-accent flex-shrink-0" />
                <span className="text-slate-300 font-bold text-sm">La Chapelle Saint Luc, AUBE, France</span>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 mr-4 text-accent flex-shrink-0" />
                <span className="text-slate-300 font-bold text-sm">Aucun numéro de téléphone n'est actuellement disponible.</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-4 text-accent flex-shrink-0" />
